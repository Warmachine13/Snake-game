    ...
    if (head.nextMove === 0) {
        ...
        if (
            ...
            if (head.position[0] === food.position[0] && head.position[1] === food.position[1]) {
                ...
                if (!food.pontos || Number.isNaN(food.pontos)) {
                    console.log('entor2222', food.pontos)
                    if (food.pontos == undefined) {
                        food.pontos = 0
                    }
                    food.pontos = food.pontos + 1;
                } else {
                    food.pontos = 0
                    console.log('entor333', food.pontos)
                }
